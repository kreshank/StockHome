...
parser = argparse.ArgumentParser("Balance Sheets Scraper")
...
frame = yf.get_balance_sheet(tkr)
pd.Dataframe.from_dict(frame).to_csv(prefix + "/" + tkr + "_bal.csv", index=False)
